...
const QuestionUpload = ({ onUploadSuccess }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
      <h3 className="text-lg font-semibold text-gray-900 mb-4">Subir Preguntas desde Archivo</h3>
      ...
      <div className="mb-4">
        ...
        >
          ⬇ Descargar plantilla {uploadType === 'bulk' ? 'de preguntas' : 'de supuesto práctico'}
        </button>
      </div>
      ...
      {/* Error Message */}
      {error && (
        <div className="mt-4 bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded" data-testid="upload-error">
          {error}
        </div>
      )}
      ...
      {/* Success Result */}
      {result && (
        <div className="mt-4 bg-green-50 border border-green-200 text-green-800 px-4 py-3 rounded" data-testid="upload-success">
